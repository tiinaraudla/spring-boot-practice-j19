...
public class UserValidatorTest {
    ...
    public void givenUser_whenIsAdminCalled_shouldExpectException() {
        ...
        try {
            ...
            String exceptedMessage = "User validation failed for user: Tiina Raudla, Error: User admin check failed!";
    ...
    public void givenUser_whenIsAdminUserCalled_shouldExpectExceptionAssert() {
        ...
        org.assertj.core.api.Assertions.assertThatExceptionOfType(UserValidationException.class)
                ...
                .withNoCause()
                .withMessageContaining("User validation failed for user: Tiina Raudla, Error: User admin check failed!");
    }
    ...
    public void givenUserWithoutUserType_whenIsAdminUserCalled_shouldExpectException() {
        ...
        Assertions.assertEquals("The user type is null for user: Tiina Raudla", exception.getLocalizedMessage());
    }
